...
- Сохрани этот файл как `docs/db/user_groups.md` в своём проекте.
- При возврате к работе — скопируй его содержимое в чат с заголовком:  
  > _"Контекст user_groups на 2025-11-07:"_  
  → Я сразу восстановлю полную картину.